...
namespace GazeteProje.Controllers
{
    public class CommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CommentId,CommentName,CommentContent,Approval")] Comments comments)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,CommentName,CommentContent,Approval")] Comments comments)
        {
